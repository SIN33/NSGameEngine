...
{
	//=====================================================
	// create factory(i.e set option of video or graghic
	//=====================================================
	...
	//=====================================================
	//create device(for create resource)
	//=====================================================
	UINT creationFlags = 0;
 
#ifdef _DEBUG
	// set error option for debug
	...
	// create swap chain
	//=====================================================
	DXGI_SWAP_CHAIN_DESC scDesc = {};		// swap chain
	scDesc.BufferDesc.Width = width;						// disp width
	scDesc.BufferDesc.Height = height;						// disp height
	...
	scDesc.SampleDesc.Quality = 0;							// not use MSAA
	scDesc.BufferUsage = DXGI_USAGE_RENDER_TARGET_OUTPUT;	// how to buffer
	scDesc.BufferCount = 2;									// num of buffer
	scDesc.OutputWindow = hWnd;
	scDesc.Windowed = TRUE;									// window mode
	...
	// get back buffer resource from swapchain
	...
	// create RTV for back buffer resource
	...
	//=====================================================
	// Set Device context info
	//=====================================================
 
	// Set back buffer As RT
